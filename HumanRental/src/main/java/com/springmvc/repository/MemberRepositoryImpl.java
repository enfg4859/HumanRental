...
//		System.out.println("회원가입");
		...
		template.update(SQL, member.getMemberId(), member.getMemberPw(), member.getName(), member.getAge(),
				member.getGender(), member.getPhone(), member.getAddress(), member.getNickName(),
				LocalDateTime.now(ZoneId.of("Asia/Seoul")), "default.png", 0);
	}
...
//	}
	...
	public void updateMember(Member member, String memberId) {
		...
		template.update(SQL, member.getMemberId(), member.getMemberPw(), member.getName(), member.getAge(),
				member.getGender(), member.getPhone(), member.getAddress(), member.getNickName(),
				member.getProfileImage(), memberId);
	}
